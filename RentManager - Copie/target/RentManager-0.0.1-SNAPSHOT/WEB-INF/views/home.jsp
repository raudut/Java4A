      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/users">Utilisateurs</a>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <a class="btn btn-primary" href="${pageContext.request.contextPath}/cars">Vehicules</a>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <a class="btn btn-primary" href="${pageContext.request.contextPath}/rents">Reservations</a>
